...
function DummyLoggerTransport(options) {
    //discard options for now
    this.level = options.level || logLevels.debug;
}

function DummyLogger(options) {}
DummyLogger.prototype.add = function() {}
DummyLogger.prototype.remove = function() {}
DummyLogger.prototype.log = function(level, data, errHandler) {
    console.log(data);
}

var winston = {
    transports: {
        File: DummyLoggerTransport,
        Console: DummyLoggerTransport
    },
    Logger: DummyLogger
};
